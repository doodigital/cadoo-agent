...
metadata:
  cadoo:
    ...
    credits: |
      ...
      https://github.com/DooStudio/kanban-video-pipeline.
---
...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `cadoo kanban create` call to a specialist profile. The kanban
