...
Data file: $CADOO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CADOO_HOME = Path(os.environ.get("CADOO_HOME", Path.home() / ".cadoo"))
DATA_DIR = _CADOO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
