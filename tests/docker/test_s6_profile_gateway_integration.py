...
The unit tests in tests/cadoo_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned cadoo-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/cadoo")
from cadoo_cli.service_manager import S6ServiceManager
