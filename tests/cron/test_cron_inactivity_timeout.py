...
class TestSysPathOrdering:
    ...
    def test_cadoo_time_importable(self):
        """cadoo_time should be importable when cron.scheduler loads."""
    ...
    def test_cadoo_constants_importable(self):
        """cadoo_constants should be importable from cron context."""
        from cadoo_constants import get_cadoo_home
        assert callable(get_cadoo_home)
