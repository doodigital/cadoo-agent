"""Tests for the ``cadoo prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from cadoo_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(cadoo_home, memory_text="", user_text=""):
    mem_dir = cadoo_home / "memories"
...
def _seed_skill(cadoo_home, name, description):
    skill_dir = cadoo_home / "skills" / "demo" / name
