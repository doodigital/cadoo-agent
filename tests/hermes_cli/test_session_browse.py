"""Tests for the interactive session browser (`cadoo sessions browse`).
...
from cadoo_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """cadoo sessions browse should be parseable."""
