...
The main() function in cadoo_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `cadoo -c model`
...
def _build_parser():
    """Build a minimal replica of the cadoo top-level parser."""
