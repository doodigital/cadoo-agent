"""Tests for `cadoo curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import cadoo_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated CADOO_HOME with real agent-created skills on disk."""
    home = tmp_path / ".cadoo"
    skills = home / "skills"
    ...
    from cadoo_cli import curator as curator_cli
