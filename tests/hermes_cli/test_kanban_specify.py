"""Tests for the specifier module + `cadoo kanban specify` CLI surface.
...
from cadoo_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `cadoo kanban …` argparse surface directly."""
