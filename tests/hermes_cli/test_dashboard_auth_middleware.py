...
from cadoo_cli.dashboard_auth.cookies import SESSION_AT_COOKIE
...
class _UnreachableProvider(StubAuthProvider):
    ...
    provider first, which tries to reach DooStudio Portal's JWKS; if that's
    ...
    def verify_session(self, *, access_token: str):
        from cadoo_cli.dashboard_auth.base import ProviderError
