...
def test_import_loads_env_from_cadoo_home(tmp_path, monkeypatch):
    home = tmp_path / ".cadoo"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-cadoo-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-cadoo-home"
