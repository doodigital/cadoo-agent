...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.cadoo/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at cadoo_state import time, before pytest's CADOO_HOME monkeypatch
    fires — the autouse fixture's CADOO_HOME override doesn't help here.)
    """
    import cadoo_state
