"""Tests for _setup_feishu() in cadoo_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("cadoo_cli.config.save_env_value", side_effect=mock_save), \
         patch("cadoo_cli.config.get_env_value", side_effect=mock_get), \
         patch("cadoo_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("cadoo_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("cadoo_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("cadoo_cli.cli_output.print_header"), \
         patch("cadoo_cli.cli_output.print_info"), \
         patch("cadoo_cli.cli_output.print_success"), \
         patch("cadoo_cli.cli_output.print_warning"), \
         patch("cadoo_cli.cli_output.print_error"), \
