...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated CADOO_HOME, yield (agent, helpers)."""
    ...
    os.makedirs(os.path.join(test_home, ".cadoo"))
    prev_home = os.environ.get("CADOO_HOME")
    os.environ["CADOO_HOME"] = os.path.join(test_home, ".cadoo")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["CADOO_HOME"] = prev_home
