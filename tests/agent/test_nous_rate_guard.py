"""Tests for agent/nous_rate_guard.py — cross-session DooStudio Portal rate limit guard."""
...
def rate_guard_env(tmp_path, monkeypatch):
    ...
    cadoo_home = str(tmp_path / ".cadoo")
    os.makedirs(cadoo_home, exist_ok=True)
...
class TestIsGenuineNousRateLimit:
    ...
    DooStudio Portal multiplexes upstreams (DeepSeek, Kimi, MiMo, Cadoo).
