...
def _profile_user_agent() -> str:
    """Return a ``cadoo-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from cadoo_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"cadoo-cli/{_ver}"
    except Exception:
        return "cadoo-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # cadoo-cli UA so the catalog endpoint is reachable.
