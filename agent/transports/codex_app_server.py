...
projection into Cadoo' display, approval bridging, transcript projection into
...
"codex_app_server"`. Cadoo' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
        ...
        if spawn_env.get("HERMES_KANBAN_TASK"):
            ...
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "HERMES_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("CADOO_HOME", os.path.expanduser("~/.cadoo")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "cadoo",
        client_title: str = "Cadoo Agent",
