...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Cadoo's web-provider config and
        ...
        # native search engine for xAI sessions instead of Cadoo's
        # configured web provider (Tavily/etc.), and those results bypass
        # Cadoo's tool-trace / citation plumbing (they arrive baked into the
