...
See the ``cadoo-dev`` skill (``references/self-improvement-loop.md``)
...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • Bundled skills (shipped with Cadoo, e.g. 'cadoo').\n"
    "  • Hub-installed skills (installed via 'cadoo skills install').\n"
    "Pinned skills (marked via 'cadoo curator pin') CAN be improved — "
