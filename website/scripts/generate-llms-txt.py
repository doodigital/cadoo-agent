...
Both publish at:
  https://doostudio.io/cadoo/docs/llms.txt
  https://doostudio.io/cadoo/docs/llms-full.txt
...
SITE_BASE = "https://doostudio.io/cadoo/docs"
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://doostudio.io/cadoo/docs\n",
        "Short index: https://doostudio.io/cadoo/docs/llms.txt\n",
        "\n---\n\n",
    ]
