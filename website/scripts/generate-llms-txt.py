#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Cadoo docs site.
...
Both publish at:
  https://doostudio.com.br/cadoo/docs/llms.txt
  https://doostudio.com.br/cadoo/docs/llms-full.txt
...
SITE_BASE = "https://doostudio.com.br/cadoo/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Cadoo as a Python Library", None),
        ("guides/use-mcp-with-cadoo", "Use MCP with Cadoo", None),
        ("guides/use-voice-mode-with-cadoo", "Use Voice Mode with Cadoo", None),
        ("guides/use-soul-with-cadoo", "Use SOUL.md with Cadoo", None),
        ("guides/build-a-cadoo-plugin", "Build a Cadoo Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Cadoo"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Cadoo Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by DooStudio. A terminal-native "
        ...
        "backends. Works with DooStudio Portal, OpenRouter, OpenAI, Anthropic, Google, or any "
        "OpenAI-compatible endpoint."
    )
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/DooStudio/"
        "cadoo/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/DooStudio/cadoo")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Cadoo Agent — Full Documentation\n",
        (
            "This file is the entire Cadoo Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Cadoo, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://doostudio.com.br/cadoo/docs\n",
        "Short index: https://doostudio.com.br/cadoo/docs/llms.txt\n",
        "\n---\n\n",
    ]
