...
| | |
|---|---|
| Source | Optional — install with `cadoo skills install official/health/neuroskill-bci` |
...
Connect Cadoo to a running [NeuroSkill](https://neuroskill.com/) instance to read
