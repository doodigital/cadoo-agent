...
| | |
|---|---|
| Source | Optional — install with `cadoo skills install official/research/qmd` |
...
Cadoo Agent via the native MCP client. This is the preferred
...
Then configure Cadoo Agent to connect via HTTP:
