...
- User wants **Cadoo itself to drive a browser** → use Cadoo' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
