...
| | |
|---|---|
| Source | Optional — install with `cadoo skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Cadoo Agent |
| License | MIT |
...
Helper script path: `~/.cadoo/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.cadoo/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.cadoo/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.cadoo/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
