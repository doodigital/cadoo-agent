...
| | |
|---|---|
| Source | Optional — install with `cadoo skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Cadoo Agent |
| License | MIT |
...
The script reads `${CADOO_HOME:-~/.cadoo}/.env` for two optional defaults:
...
Helper script: `~/.cadoo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.cadoo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${CADOO_HOME:-~/.cadoo}/.env`.
...
```bash
python3 ~/.cadoo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.cadoo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
