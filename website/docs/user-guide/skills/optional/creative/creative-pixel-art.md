...
| | |
|---|---|
| Source | Optional — install with `cadoo skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.cadoo/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.cadoo/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Cadoo installs package this)
