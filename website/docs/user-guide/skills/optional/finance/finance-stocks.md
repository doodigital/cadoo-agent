...
| | |
|---|---|
| Source | Optional — install with `cadoo skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Cadoo Agent |
| License | MIT |
...
```
SCRIPT=~/.cadoo/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.cadoo/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
