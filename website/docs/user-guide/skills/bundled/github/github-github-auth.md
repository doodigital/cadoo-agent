...
- Give it a title like "cadoo-&lt;machine-name>"
...
elif _hermes_env="${CADOO_HOME:-$HOME/.cadoo}/.env"; [ -f "$_hermes_env" ] && grep -q "^GITHUB_TOKEN=" "$_hermes_env"; then
