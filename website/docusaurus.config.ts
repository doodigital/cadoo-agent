...
const config: Config = {
  ...
  url: 'https://doostudio.io/cadoo',
  baseUrl: '/docs/',

  organizationName: 'DooStudio',
  projectName: 'cadoo',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/DooStudio/cadoo/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/DooStudio/cadoo',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https://discord.gg/DooStudio',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/DooStudio' },
            { label: 'GitHub Issues', href: 'https://github.com/DooStudio/cadoo/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://doostudio.io/cadoo/' },
            { label: 'GitHub', href: 'https://github.com/DooStudio/cadoo' },
            { label: 'DooStudio', href: 'https://doostudio.io' },
          ],
        },
      ],
      copyright: `Built by <a href="https://doostudio.io">DooStudio</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
