#!/usr/bin/env python3
"""Google Workspace API CLI for Cadoo Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Cadoo-facing JSON contract and falls back to the Python client
...
from _cadoo_home import get_cadoo_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Cadoo Agent")
