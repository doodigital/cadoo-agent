...
Built for [Cadoo Agent](https://github.com/DooStudio/cadoo). Usable in any coding agent. Canonical source lives here; synced to [`DooStudio/cadoo/skills/creative/ascii-video`](https://github.com/DooStudio/cadoo/tree/main/skills/creative/ascii-video) via PR.
