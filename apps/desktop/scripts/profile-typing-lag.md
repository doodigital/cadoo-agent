...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/cadoo-typing
# → /tmp/cadoo-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/cadoo-typing.before.heapsnapshot
# → /tmp/cadoo-typing.after.heapsnapshot
```
