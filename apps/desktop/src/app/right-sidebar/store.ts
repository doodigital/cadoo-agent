...
const TAKEOVER_KEY = 'cadoo.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Cadoo can't clear via the API — the user
 *  sees exactly what runs instead of Cadoo silently deleting their creds. */
