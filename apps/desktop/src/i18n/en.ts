...
export const en: Translations = {
  ...
  boot: {
    ready: 'Cadoo Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Cadoo settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Cadoo Desktop…'
    },
    errors: {
      backgroundExited: 'Cadoo background process exited.',
      backgroundExitedDuringStartup: 'Cadoo background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Cadoo backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Cadoo',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Cadoo Desktop.',
    ...
    native: {
      ...
      inputBody: 'Cadoo is waiting for your response.',
      turnDoneTitle: 'Cadoo finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Cadoo defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Cadoo is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Cadoo asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Cadoo was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Cadoo follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Cadoo is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Cadoo, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Cadoo checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Cadoo configuration...',
    ...
    gateway: {
      ...
      intro:
        'Cadoo Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Cadoo backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Cadoo backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Cadoo backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /cadoo.',
      ...
      restartingMessage: 'Cadoo Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Cadoo ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Cadoo runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Nous subscription — sign in to DooStudio Portal to activate.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Cadoo to use pets — the backend predates this feature.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Cadoo desktop' },
    ...
    hermesActiveSessions: (version, count) => `Cadoo ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@cadoo:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Cadoo environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Cadoo will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Cadoo...',
    placeholderReconnecting: 'Reconnecting to Cadoo…',
    ...
    attachUrlDesc: 'Cadoo will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Cadoo…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Cadoo…',
    ...
    unsupportedMessage: 'This version of Cadoo can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Cadoo from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Cadoo will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Cadoo desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Cadoo updater takes over in its own window and reopens Cadoo automatically when it’s done. Please don’t reopen Cadoo yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Cadoo reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Cadoo reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Cadoo needs a one-time install',
    ...
    settingUpTitle: 'Setting up Cadoo Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Cadoo CLI or desktop instance is running. Stop any running Cadoo instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Cadoo installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Cadoo Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Cadoo is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Cadoo…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Cadoo',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Cadoo at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Cadoo connects automatically',
      loopback: 'Opens your browser to sign in — Cadoo connects automatically',
    ...
    authorizeThere: 'Authorize Cadoo there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Cadoo there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Cadoo inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Cadoo will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Cadoo is restarting...',
      askRestart: 'Ask Cadoo to restart the server',
      lookingRestart: taskId => `Cadoo is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Cadoo is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Cadoo finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Cadoo could not restart the server.',
      stillWorking:
        'Cadoo is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Cadoo is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Cadoo gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.cadoo/config.yaml). Cadoo won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Cadoo needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Cadoo needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Cadoo Desktop to use Save Image.',
    restartToSaveImages: 'Restart Cadoo Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `cadoo gateway` running?'
    }
  },
