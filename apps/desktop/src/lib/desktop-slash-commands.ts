...
/** Why a known Cadoo command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Cadoo profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Cadoo Agent version', surface: exec() },
 ...
 * Cadoo' built-in slash commands — i.e. skill commands (`/gif-search`,
