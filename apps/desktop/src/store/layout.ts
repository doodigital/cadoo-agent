...
const SIDEBAR_PINNED_STORAGE_KEY = 'cadoo.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'cadoo.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'cadoo.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'cadoo.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'cadoo.desktop.sessionOrder'
const SIDEBAR_SESSION_ORDER_MANUAL_STORAGE_KEY = 'cadoo.desktop.sessionOrder.manual'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'cadoo.desktop.workspaceOrder'
const SIDEBAR_WORKSPACE_PARENT_ORDER_STORAGE_KEY = 'cadoo.desktop.workspaceParentOrder'
const PANES_FLIPPED_STORAGE_KEY = 'cadoo.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'cadoo:focus-session-search'
