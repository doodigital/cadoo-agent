#!/usr/bin/env python3
"""Build the Cadoo Model Catalog — a centralized JSON manifest of curated models.
...
Cadoo CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Cadoo release.
...
# Ensure CADOO_HOME is set for imports that touch it at module level.
os.environ.setdefault("CADOO_HOME", os.path.join(os.path.expanduser("~"), ".cadoo"))

from cadoo_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "cadoo repo",
            "docs": "https://doostudio.com.br/cadoo/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
