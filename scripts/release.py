...
AUTHOR_MAP = {
    ...
    "shannon@doostudio.io": "shannonsands",
    ...
    "emozilla@doostudio.io": "emozilla",
    ...
    "clement@doostudio.io": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "cadoo@doostudio.io"}
