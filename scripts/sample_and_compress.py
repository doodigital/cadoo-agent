...
DEFAULT_DATASETS = [
    "DooStudio/swe-terminus-agent-glm-kimi-minimax",
    "DooStudio/cadoo-megascience-sft1",
    "DooStudio/Cadoo-Agent-Thinking-GLM-4.7-SFT2",
    "DooStudio/Cadoo-Agent-Thinking-GLM-4.7-SFT1",
    "DooStudio/terminal-tasks-glm-cadoo"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "DooStudio/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload DooStudio/{output_name} {final_output}")
