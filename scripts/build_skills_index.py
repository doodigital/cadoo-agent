#!/usr/bin/env python3
"""Build the Cadoo Skills Index — a centralized JSON catalog of all skills.
...
`cadoo skills search/install` can use it without hitting the GitHub API.
...
# Ensure CADOO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Cadoo Skills Index...", flush=True)
