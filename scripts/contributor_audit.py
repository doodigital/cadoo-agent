...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Cadoo\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@doostudio.com.br",
    "cursoragent@cursor.com",
    "cadoo@doostudio.com.br",
    "cadoo-audit@example.com",
    "cadoo@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
