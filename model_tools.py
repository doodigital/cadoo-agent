...
#   - cli.py, cadoo_cli/*      -> inline on startup (no event loop)
...
def _compute_tool_definitions(
    ...
    # This ensures that even if a composite toolset (like cadoo-cli)
...
def _resolve_active_context_length() -> int:
    ...
    """
    try:
        from cadoo_cli.config import load_config as _load
        cfg = _load() or {}
...
def _emit_post_tool_call_hook(
    *,
    ...
    """
    try:
        from cadoo_cli.plugins import has_hook, invoke_hook
