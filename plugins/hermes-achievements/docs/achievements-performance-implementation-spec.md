# Cadoo Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.cadoo/plugins/cadoo-achievements/state.json` (existing unlock state)
  - `~/.cadoo/plugins/cadoo-achievements/scan_snapshot.json` (new)
  - `~/.cadoo/plugins/cadoo-achievements/scan_checkpoint.json` (new)
