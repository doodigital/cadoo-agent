# Cadoo Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.cadoo/plugins/cadoo-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.cadoo/plugins/cadoo-achievements/scan_checkpoint.json`.
