...
``_check_spotify_available()`` — when the user has not run ``cadoo auth
spotify``, the tools remain registered (so they appear in ``cadoo
...
The Spotify auth flow (``cadoo auth spotify``), CLI plumbing, and docs
