...
Config: ~/.cadoo/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.cadoo/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_cadoo_home()`` helper (CADOO_HOME-aware and
...
RULES_FILE = get_cadoo_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_cadoo_home() / "feishu_comment_pairing.json"
