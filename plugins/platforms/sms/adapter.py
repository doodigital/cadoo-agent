...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Cadoo gateway adapter.

    Each inbound phone number gets its own Cadoo session (multi-tenant).
...
# static dict in cadoo_cli/gateway.py, and the _send_sms dispatch in
