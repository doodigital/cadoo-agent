...
required — uses aiohttp which is already a Cadoo dependency.
...
def interactive_setup() -> None:
    ...
    ``cadoo_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Cadoo delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # cadoo_cli/setup.py::_setup_mattermost function.
