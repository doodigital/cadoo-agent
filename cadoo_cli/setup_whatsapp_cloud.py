...
Entry point: ``cadoo whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``cadoo_cli/main.py``).
...
Cadoo gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Cadoo to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Cadoo needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Cadoo gateway in another terminal:")
    print("         cadoo gateway")
    print()
    ...
    print()
    print("  Docs: https://doostudio.com.br/cadoo/docs/user-guide/")
