"""
Cadoo CLI - Unified command-line interface for Cadoo Agent.

Provides subcommands for:
- cadoo chat          - Interactive chat (same as ./cadoo)
- cadoo gateway       - Run gateway in foreground
- cadoo gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `cadoo setup` on a fresh Pi.
    ...
    cadoo_cli/stdio.py::configure_windows_stdio() runs later from the entry
