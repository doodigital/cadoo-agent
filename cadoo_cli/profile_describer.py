...
Used by ``cadoo profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``cadoo_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Cadoo Agent kanban board.
...
Rules:
  ...
  - Never write "Cadoo Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_cadoo_home())
        else:
