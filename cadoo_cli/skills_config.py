"""
Skills configuration for Cadoo Agent.
`cadoo skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.cadoo/config.yaml under:
...
from cadoo_cli.config import cfg_get, load_config, save_config
from cadoo_cli.colors import Colors, color
from cadoo_cli.platforms import PLATFORMS as _PLATFORMS
