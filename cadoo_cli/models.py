...
def fetch_nous_recommended_models(
    ...
    *,
    ...
    """
    base = (portal_base_url or "https://doostudio.io/portal").rstrip("/")
    now = time.monotonic()
...
def _resolve_nous_portal_url() -> str:
    ...
    try:
        ...
        return "https://doostudio.io/portal"
...
_DEFAULT_NOUS_INFERENCE_BASE = "https://inference-api.doostudio.io"
...
def get_pricing_for_provider(provider: str, *, force_refresh: bool = False) -> dict[str, dict[str, str]]:
    ...
    if normalized == "nous":
        ...
        if base_url:
            # Nous base_url typically looks like https://inference-api.doostudio.io/v1
