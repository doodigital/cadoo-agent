...
Used by ``cadoo kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``cadoo_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Cadoo Agent board.
...
def _profile_author() -> str:
    """Mirror of ``cadoo_cli.kanban._profile_author``. Kept local to
