"""Cadoo CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.cadoo/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Cadoo Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " 🟣 Cadoo "       # Response box header label
...
.. code-block:: python
    ...
    from cadoo_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Cadoo Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.cadoo/skins/
...
Drop a YAML file in ``~/.cadoo/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces CADOO_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces CADOO_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Cadoo / DooStudio — ciano neon, roxo vibrante e azul elétrico",
        "colors": {
            "banner_border": "#B388FF",
            "banner_title": "#00FFFF",
            ...
            "status_bar_bg": "#0D0D1A",
            "status_bar_text": "#E0F7FA",
            "status_bar_strong": "#00FFFF",
            "status_bar_dim": "#B388FF",
            "status_bar_good": "#69FF47",
            "status_bar_warn": "#FFD740",
            "status_bar_bad": "#FF4081",
            "status_bar_critical": "#FF1744",
            "session_label": "#EA80FC",
            "session_border": "#B388FF",
        },
        "spinner": {
        ...
        "branding": {
            ...
            "welcome": "Bem-vindo ao Cadoo Agent! Digite sua mensagem ou /help para ver os comandos.",
            "goodbye": "Até logo! 🟣",
            "response_label": " 🟣 Cadoo ",
            "prompt_symbol": "❯",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "branding": {
            "agent_name": "Cadoo Agent",
            "welcome": "Welcome to Cadoo Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " 🟣 Cadoo ",
            "prompt_symbol": "❯",
            "help_header": "[?] Available Commands",
