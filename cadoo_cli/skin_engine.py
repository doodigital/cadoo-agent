...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Cadoo / DooStudio — roxo profundo, violeta e detalhes neon",
        "colors": {
            "banner_border": "#7B2FBE",
            "banner_title": "#C77DFF",
            "banner_accent": "#9D4EDD",
            "banner_dim": "#5A189A",
            "banner_text": "#E0AAFF",
            "ui_accent": "#C77DFF",
            "ui_label": "#9D4EDD",
            ...
            "prompt": "#E0AAFF",
            "input_rule": "#7B2FBE",
            "response_border": "#C77DFF",
            "status_bar_bg": "#1A0A2E",
            "status_bar_text": "#E0AAFF",
            "status_bar_strong": "#C77DFF",
            "status_bar_dim": "#5A189A",
            "status_bar_good": "#7BF1A8",
            "status_bar_warn": "#FFB347",
            "status_bar_bad": "#FF6B9D",
            "status_bar_critical": "#FF3C3C",
