...
Invoked by ``cadoo kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Cadoo Agent board.
...
def _profile_author() -> str:
    """Mirror of ``cadoo_cli.kanban._profile_author``."""
    return (
