...
Usage:
    cadoo pairing list              # Show all pending + approved users
    cadoo pairing approve <platform> <code>  # Approve a pairing code
    cadoo pairing revoke <platform> <user_id> # Revoke user access
    cadoo pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle cadoo pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: cadoo pairing {list|approve|revoke|clear-pending}")
        print("Run 'cadoo pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.cadoo/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'cadoo pairing list' to see pending codes.\n")
