...
def auth_json_path():
    """Return the Cadoo auth store path, respecting CADOO_HOME overrides."""
    return get_cadoo_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`cadoo tools`, banner/status paint, provider
