...
One ``CDPSupervisor`` runs per Cadoo ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "cadoo-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://cadoo-dialog-bridge.invalid/";
