...
Trust levels:
  - builtin:   Ships with Cadoo. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.cadoo/\.env|\~/\.cadoo/\.env',
     "hermes_env_access", "critical", "exfiltration",
     "directly references Cadoo secrets file"),
    ...
    (r'\.cadoo/config\.yaml|\.cadoo/SOUL\.md',
     "hermes_config_mod", "critical", "persistence",
     "references Cadoo configuration files directly"),
...
# scan. `.skillignore` is the Cadoo-native name; `.clawhubignore` is honored
