 ...
 *
 * Values mirror cadoo_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Cadoo default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Cadoo' default when unset). */
