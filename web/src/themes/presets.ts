 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `cadoo_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Cadoo Teal",
  description: "Classic dark teal — the canonical Cadoo look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Cadoo look, ported from the
 ...
 * nousnet-web's <body> is white; cadoo's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Cadoo Teal (Large)",
  description: "Cadoo Teal with bigger fonts and roomier spacing",
