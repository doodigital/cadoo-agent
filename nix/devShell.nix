...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      hermesNpmLib = self'.packages.default.passthru.cadooNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. cadoo
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Cadoo Agent dev shell"
          ${combinedNonNpm}
          ${hermesNpmLib.mkNpmDevShellHook npmPackageJsonPaths}
          echo "Ready. Run 'cadoo' to start."
        '';
      };
    };
}
