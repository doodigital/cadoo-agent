# nix/web.nix — Cadoo Web Dashboard (Vite/React) frontend build
{ pkgs, hermesNpmLib, ... }:
let
  npm = hermesNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "cadoo-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../cadoo_cli/web_dist for the
