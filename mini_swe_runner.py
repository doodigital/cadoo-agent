#!/usr/bin/env python3
"""
SWE Runner with Cadoo Trajectory Format

A runner that uses Cadoo-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Cadoo-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Cadoo-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Cadoo format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Cadoo-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Cadoo-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Cadoo Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Cadoo-Agent's built-in execution environments
    and outputs trajectories in Cadoo-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Cadoo trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Cadoo trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Cadoo trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Cadoo Trajectory Format")
    print("=" * 60)
