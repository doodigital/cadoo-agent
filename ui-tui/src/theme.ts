...
// Mirrors @cadoo/ink's colorize.ts. Keep local: app code compiles from
// ui-tui/src, while @cadoo/ink is bundled separately from packages/.
...
//
// Anything we can't decide stays dark — the default Cadoo palette
// is the dark one.
