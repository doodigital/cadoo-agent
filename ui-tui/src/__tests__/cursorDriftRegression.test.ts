 ...
 *
 * Symptom: in `cadoo --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@cadoo/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using cadoo --tui and as i type multiline my caret at the end will often ' +
